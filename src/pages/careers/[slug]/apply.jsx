...
const T = {
  ...
  bg2: "#F8FAFC",
  hover: "#F1F5F9",
  border: "var(--border-subtle, #E2E8F0)",
  div: "#E2E8F0",
  teal: "var(--teal, #0EA5E9)",
  orange: "#17262B",
  orangeH: "#223A42",
  white: "var(--text, #0F172A)", // used for main text
  gray: "var(--text-muted, #475569)",
...
function SectionHeading({ icon, iconColor = T.teal, children }) {
  return (
    <div className="section-heading" style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
      <div style={{
        width: 40, height: 40,
        borderRadius: 10,
        background: T.bg0,
...
function StepBar({ current, steps }) {
  return (
    <div style={{ display: "flex", alignItems: "flex-start", gap: 0, marginBottom: 36, overflowX: "auto", paddingBottom: 10 }}>
      {steps.map((step, i) => {
        ...
        return (
          <React.Fragment key={step.id}>
            ...
            {i < steps.length - 1 && (
              <div style={{ flex: 1, minWidth: 20, height: 2, background: i < current ? T.teal : T.border, marginTop: 14, transition: "background 0.3s" }} />
            )}
          </React.Fragment>
        );
      })}
...
export default function JobApplicationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://auxosys-backend.onrender.com'}/job/${slug}/apply`, {
        method: "POST",
        body: formData,
      });
      ...
      <div style={{ minHeight: "100vh", background: T.bg0, display: "flex", alignItems: "center", justifyContent: "center", padding: 32 }}>
        <div style={{ textAlign: "center", maxWidth: 480, animation: "fadeIn 0.5s ease-out" }}>
          ...
          <Link href="/careers" style={{
            ...
            background: T.orange, color: "#ffffff", fontWeight: 700,
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          .app-layout { gap: 16px !important; }
          .page-wrap { padding: 20px 16px 40px !important; }
          .page-title { font-size: 26px !important; }
          .section-card { padding: 24px 20px !important; border-radius: 16px !important; margin-bottom: 16px !important; }
          ...
          .review-label { width: 100%; font-size: 12.5px; }
          .review-value { font-size: 14px; word-break: break-word; }
          
          /* Navigation */
          .nav-btns { flex-direction: column-reverse; gap: 12px; margin-top: 16px !important; }
          .btn-nav { width: 100%; justify-content: center; }

          /* Application Tips */
          .application-tips { display: none !important; }
        }
        ...
        <div className="page-wrap" style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px 80px" }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
              <h1 className="page-title" style={{ fontSize: 34, fontWeight: 800, color: T.white, letterSpacing: "-0.02em", margin: 0 }}>
                Application Wizard
              </h1>
              <span style={{
          ...
          <div className="app-layout" style={{ display: "flex", gap: 32, alignItems: "flex-start" }}>
            ...
            <div className="sidebar" style={{ width: 300, flexShrink: 0, position: "sticky", top: 100 }}>
              ...
              <div className="section-card application-tips" style={{ 
                background: "rgba(92,201,214,0.05)", 
                borderColor: "rgba(92,201,214,0.2)",
            ...
            <div className="form-col" style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                ...
                {/* ── Navigation Buttons ── */}
                {currentStepId !== "submit" && (
                  <div className="nav-btns" style={{ display: "flex", justifyContent: "space-between", marginTop: 10 }}>
                    {currentStep > 0 ? (
                ...
                {currentStepId === "submit" && (
                  <div className="nav-btns" style={{ display: "flex", justifyContent: "flex-start", marginTop: 10 }}>
                    <button type="button" onClick={prevStep} className="btn-nav btn-prev">
                      {Icons.back} Previous
                    </button>
                  </div>
